...
public class S4DealNumberValidationServiceImpl implements S4DealNumberValidationService {
    ...
    private final String dealNrS4AddisonURL = CacheConfig.getValue("DEAL_NR_S4_ADDISON_URL");
    ...
    public String getS4DealNumberResponse(String dealNr) {
        ...
        while (retries <= MAX_RETRIES) {
            ...
            try {
                String urlStr = appendQueryParams(dealNrS4AddisonURL, "dealNumber", dealNr);
...
 static final String S4_DEAL_NR_ADDISON_URL = CacheConfig.getValue("DEAL_NR_S4_ADDISON_URL");
